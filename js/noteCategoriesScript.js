$('document').ready(function () {
    ...
    function prepareEditForm(element) {
        ...
        $('#updateNoteCategoryName').on('click', function (event) {
            ...
            if($('#noteCategoryEditForm').valid()) {
                $('#errorMessage').empty();
                updateNoteCategory($('#editedNoteCategoryName').attr("data-id"));
                id = null;
            }
            else
    ...
    function appendNoteCategory(noteCategoryData) {
        ...
        setEditEvent(noteCategoryData.ID);
        setDeleteEvent(noteCategoryData.ID);
    }
        ...
        $.post(
            ...
            function (response) {
                if (JSON.parse(response)) {
                    ...
                    $('#edit_' + id).attr('data-notecategoryname', $('#editedNoteCategoryName').val());
                    showEditForm = false;
                    showHideEditForm();
                }
