...
function createNoteCategoriesList(noteCategories) {
    ...
    for(var key in noteCategories) {
        $("[name='categoryName']").append($('<option>', {value: noteCategories[key].ID, text: noteCategories[key].name}));
    }
}
...
function createStudentsList(students) {
    ...
    for(var key in students) {
        $("[name='studentName']").append($('<option>', {value: students[key].ID, text: students[key].name + " " + students[key].surname}));
    }
}
...
function prepareEditForm(element) {
    ...
    $('#updateNote').click(function() {updateNote(id)});
}
